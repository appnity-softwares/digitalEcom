            ...
            >
                <div className="glass-card rounded-[2rem] p-8 md:p-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground">Sign in to access your templates and orders.</p>
                    </div>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-secondary text-muted-foreground font-medium">or continue with email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Link to="/forgot-password" className="text-sm text-primary font-semibold hover:text-primary/80">
                                    Forgot password?
                                </Link>
                            </div>
                            <input
